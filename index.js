...
`).join("")}const p=document.querySelectorAll(".faqs-item input");p.forEach(e=>{e.addEventListener("change",()=>{e.checked&&p.forEach(i=>{i!==e&&(i.checked=!1)})})});async function S(){new l(".how-to-play-swiper",{modules:[g,m,b],navigation:{prevEl:".how-to-play-pagination-prev",nextEl:".how-to-play-pagination-next"},keyboard:{enabled:!0},on:{init(){u(this)},slideChange(){u(this)}},breakpoints:{300:{slidesPerView:1,slidesPerGroup:1,spaceBetween:24,grid:{rows:3,fill:"row"}},1440:{slidesPerView:3,slidesPerGroup:3,spaceBetween:24,grid:{rows:3,fill:"row"}}}})}function u(e){const i=document.querySelector(".how-to-play-pagination-prev"),a=document.querySelector(".how-to-play-pagination-next");i.disabled=e.isBeginning,a.disabled=e.isEnd}h();x();S();
